    ...
    return (
        <div className="w-full max-w-6xl mx-auto p-6 space-y-10">
            <div className="flex justify-end mb-6">
                <button
                    onClick={() => {
                        window.location.href = "/plancreator";
                    }}
                    className="px-6 py-3 bg-green-500 text-white font-semibold rounded-lg shadow hover:bg-green-600 hover:shadow-lg transition duration-300"
                >
                    Crear Plan
                </button>
            </div>
